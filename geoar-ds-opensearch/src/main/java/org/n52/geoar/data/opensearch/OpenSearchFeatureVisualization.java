...
public class OpenSearchFeatureVisualization implements
	...
	public View getFeatureView(SpatialEntity entity, View convertView,
		...
		if (entity instanceof OpenSearchMeasurement) {
			OpenSearchMeasurement noiseMeasurement = (OpenSearchMeasurement) entity;
