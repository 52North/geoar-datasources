...
public interface OpenSearchQueryBuilder {
	...
	public boolean isParameterSetted(String parameterNames) throws ParameterNotExistException;
	
	public boolean areParametersSetted(String... parameterNames) throws ParameterNotExistException;
	
	public boolean isQueryComplete();
	
	public String getParameterValue(String parameterName) throws ParameterNotExistException;
